...
class Presentation_With_Author(object):
    ...
    birth_date : str
    date = str
    def __init__(self, title, full_name, birth_date, date):        
        self.title = title
...
async def read_presentation(title: str):
    ...
    presentationWithAuthor = Presentation_With_Author(presentation.title, "{} {}".format(author.first_name, author.last_name), author.birth_date, presentation.date)
